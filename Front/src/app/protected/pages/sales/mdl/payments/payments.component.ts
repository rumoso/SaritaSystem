...
@Component({
  ...
  // Se importan los estilos base de nsale (clases ns-*): son el sistema
  // de diseño compartido del área de ventas, igual que en VioletaSystem.
...
// borrar primero. El setTimeout es porque currencyMask reformatea el
// valor al enfocar y eso deshace la selección si se hace de inmediato.
